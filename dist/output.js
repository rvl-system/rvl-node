...
// {{PRE_LIBRARY}}
  ...
  function _jsPrintChar(
  ) {
  err('missing function: jsPrintChar'); abort(-1);
  }
  ...
  function _jsPrintlnChar(
  ) {
  err('missing function: jsPrintlnChar'); abort(-1);
  }
